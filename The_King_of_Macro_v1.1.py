...
# ====================================================================================================
"""
<The_King_of_Macro_v1.1> - 21.12.9.목 21:29
* Made by Yoonmen *

[update]
1. 딜레이 관련 설정 변경
2. 매크로 작동 완료 후 메시지 출력
"""
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "The_King_of_Macro_v1.1"))
        self.Add_Button.setText(_translate("Form", "추가"))
        self.label.setText(_translate("Form", "The King of Macro"))
        self.label_4.setText(_translate("Form", "v1.1"))
    ...
    def Add_CLICK(self) : 
        if Load_status == 1 : 
            ...
            if len(CSV_data[object + 1]) == 1 : 
                ...
                CSV_data[object + 1][1] = self.Delay_doubleSpinBox.value()
