...
[update]
1. 칼라 체커 기능 추가
2. (설정 창에서) '매크로 프로그램을 가장 위로' 선택 기능 추가
"""
...
class BasicFn(QObject) : 
    ...
    def winToTop(self) : 
        if settingUI.winToTop_ckb.isChecked() : 
            print("[system] winToTop_ckb의 상태 : Checked")      # Test code / please delete this line.
            ...
            # mainUI.setWindowFlags(Qt.WindowStaysOnTopHint)
            # settingUI.setWindowFlags(Qt.WindowStaysOnTopHint)
            # editUI.setWindowFlags(Qt.WindowStaysOnTopHint)


        else : 
            print("[system] winToTop_ckb의 상태 : Unchecked")     # Test code / please delete this line.
